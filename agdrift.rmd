...
There are multiple sources of data for deposition curves of the various AgDrift application methods:
  ...
  + Datasets from the FORTRAN code source of AgDrift
...
```
The diagrams below depict the current options in the Ubertool web application (grayed) with the recommended options in the 2012 OPP memorandum (underlined).
```
...
Source           | Peck Excel | User Manual | Ubertool   | fortran2py.py | AgDrift Model |  
-----------------|:----------:|:-----------:|:----------:|:-------------:|:-------------:|  
Aerial vf2f      |  x         |             |  x         |  x            |  x            |  
Aerial f2m       |  x         |             |  x         |  x            |  x            |  
Aerial m2c       |  x         |             |  x         |  x            |  x            |  
Aerial c2vc      |  x         |             |  x         |  x            |  x            |  
Ground high vf2f |  x         |  x          |  x         |  x            |  x            |  
Ground high f2m  |  x         |  x          |  x         |  x            |  x            |  
Ground low vf2f  |  x         |  x          |  x         |  x            |  x            |  
Ground low f2m   |  x         |  x          |  x         |  x            |  x            |  
Airblast orchard |  x         |  x          |  x         |  x            |  x            |  
Airblast vineyard|  x         |  x          |  x         |  x            |  x            |  
Airblast normal  |  x         |  x          |            |  x            |  x            |  
Airblast sparse  |  x         |  x          |            |  x            |  x            |  
Airblast dense   |  x         |  x          |            |  x            |  x            |  
_Plot keyword_   | _Peck_     | _Calc_      | _Python_   | _FORTRAN_     | _GUI_         |  
...
legend("topright", c("Python", "Peck", "Fortran", "GUI Dep", "GUI Ponddep"), col = c("black", "blue","green3", "red", "purple"), lty = c(1, 2, 3, 4,5), bg = "gray90", cex=1)
## Fine to medium
...
lines(df_aerial_excel$Distance..ft., df_aerial_excel$Fine.to.Med, lty=2, col = "blue")
...
par(mfrow=c(2,2), mar=c(4,4,2,1))
plot(df_ground_excel$Distance..ft., df_ground_excel$Low.boom..vf, main = "Low vf2f", type = "l", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300),ylim=c(0,0.3))
...
legend("topright", c("Peck", "Calc 90", "Calc 50", "Fortran", "Python", "GUI 90 Dep", "GUI 50 Dep", "GUI 90 Ponddep", "GUI 50 Ponddep"), col = c("black", "blue","green3", "red", "purple", "orange", 74, 75, 565), lty = c(1, 2, 2, 3, 4, 5,5,6,6), bg = "gray90", cex = 0.75)
## Low- fine to medium coarse
plot(df_ground_excel$Distance..ft., df_ground_excel$low.boom..fmc, main = "Low f2mc", type = "l", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300),ylim=c(0,0.3))
...
plot(df_ground_excel$Distance..ft., df_ground_excel$High.boom..vf, main = "High Vf2f", type = "l", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300),ylim=c(0,0.3))
...
plot(df_ground_excel$Distance..ft., df_ground_excel$high.boom..fmc, main = "High f2mc", type = "l", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300),ylim=c(0,0.3))
...
legend("topright", c("Peck", "Calc Outside", "Calc Inside", "Python", "Fortran", "GUI Dep", "GUI Ponddep"), col = c("black", "blue", "green3", "red", "purple", "orange", 74), lty = c(1, 2, 2, 3, 4, 5,6), bg = "gray90", cex=1)
## Vineyard
...
* Why does the AgDrift model differ from the field study curves (Teske et al. 2003)?
* Should all Tier I deposition curves come from the same source?
* Why do the FORTRAN deposition curves differ from the AgDrift 2.1.1 model?
