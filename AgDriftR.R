...
lines(df_aerial_excel$Distance..ft., df_aerial_excel$Very.Fine.to.Fine, lty=2, col = "blue")
lines(df_fortran2py$distance_ft, df_fortran2py$Aerial.vf2f, lty = 3, col = "green3")
lines(df_model_aerial$Distance_ft, df_model_aerial$vf2f_dep, lty = 4, col = "red")
lines(df_model_aerial$Distance_ft, df_model_aerial$vf2f_ponddep, lty = 5, col = "purple")
legend("topright", c("Python", "Peck", "Fortran", "GUI", "GUI Ponddep"), col = c("black", "blue","green3", "red", "purple"), lty = c(1, 2, 3, 4,5), bg = "gray90", cex=1)
## Fine to medium
plot(df_python$distance_ft, df_python$pond_aerial_f2m, main = "f2m", type = "l", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300), ylim=c(0, 0.55))
lines(df_aerial_excel$Distance..ft., df_aerial_excel$Fine.to.Med, col = "red", lty=2, col = "blue")
lines(df_fortran2py$distance_ft, df_fortran2py$Aerial.f2m, lty=3, col = "green3")
lines(df_model_aerial$Distance_ft, df_model_aerial$f2m_dep, lty=4, col = "red")
lines(df_model_aerial$Distance_ft, df_model_aerial$f2m_ponddep, lty=5, col = "purple")
legend("topright", c("Python", "Peck", "Fortran", "GUI", "GUI Ponddep"), col = c("black", "blue","green3", "red", "purple"), lty = c(1, 2, 3, 4, 5), bg = "gray90", cex=1)
## Medium to coarse
plot(df_python$distance_ft, df_python$pond_aerial_m2c, type = "l", main = "m2c", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300), ylim=c(0, 0.55))
lines(df_aerial_excel$Distance..ft., df_aerial_excel$Med.to.Coarse, lty=2, col = "blue")
lines(df_fortran2py$distance_ft, df_fortran2py$Aerial.m2c, lty=3, col = "green3")
lines(df_model_aerial$Distance_ft, df_model_aerial$m2c_dep, lty=4, col= "red")
lines(df_model_aerial$Distance_ft, df_model_aerial$m2c_ponddep, lty=5, col = "purple")
legend("topright", c("Python", "Peck", "Fortran", "GUI", "GUI Ponddep"), col = c("black", "blue","green3", "red", "purple"), lty = c(1, 2, 3, 4,5), bg = "gray90", cex=1)
## Coarse to very coarse
plot(df_python$distance_ft, df_python$pond_aerial_c2vc, type = "l", main = "c2vc", xlab = "Distance (ft)", ylab = "Fraction of Deposition",xlim=c(0,300), ylim=c(0, 0.55))
lines(df_aerial_excel$Distance..ft., df_aerial_excel$Coarse.to.VC, lty=2, col ="blue")
...
legend("topright", c("Peck", "Calc 90", "Calc 50", "Fortran", "Python", "GUI 90", "GUI 50", "GUI 90 Ponddep", "GUI 50 Ponddep"), col = c("black", "blue","green3", "red", "purple", "orange", 74, 75, 565), lty = c(1, 2, 2, 3, 4, 5,5,6,6), bg = "gray90", cex = 1)
...
legend("topright", c("Peck", "Calc Outside", "Calc Inside", "Python", "Fortran", "GUI", "GUI Ponddep"), col = c("black", "blue", "green3", "red", "purple", "orange", 74), lty = c(1, 2, 2, 3, 4, 5,6), bg = "gray90", cex=1)
## Vineyard
